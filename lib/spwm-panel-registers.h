...
// Return how many generated regtype profiles can be selected for this panel.
// Positive --led-spwm-register-config values use this 1-based range.
...
// overlay generated regtypeN when spwm_register_config is positive. Register
